...
st.title("💊 AIDriven Drug Discovery System")

# -----------------------------
# LOAD TRAINED MODEL
# -----------------------------
model = joblib.load(r"C:\Users\preks\Downloads\archive\drug_model.pkl")

# -----------------------------
# LOAD DATASET
# -----------------------------
data = pd.read_csv(r"C:\Users\preks\Downloads\archive\drug_dataset.csv")
